...
> - `PATCH /api/admin/judges/{judgeId}` - 更新单个评委投票

详见：[NEW_API_DEVELOPMENT.md - 1. 评委管理接口](./NEW_API_DEVELOPMENT.md#1-评委管理接口-新增)
...
> - `GET /api/admin/debate-flow/status` - 获取流程当前状态

详见：[NEW_API_DEVELOPMENT.md - 2. 流程管理接口](./NEW_API_DEVELOPMENT.md#2-流程管理接口-新增)
